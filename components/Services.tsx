      ...
      <div className="container mx-auto px-4">
        ...
        >
          {services.map((service) => (
            <motion.div
              key={service.id}
              className="relative bg-black/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-800 hover:border-blue-500/50 transition-all duration-300 group overflow-hidden"
