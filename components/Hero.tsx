      ...
      <div className="container mx-auto px-6 sm:px-8 text-center relative z-10 flex flex-col items-center">
        ...
        >
          <Link href="/contact" aria-label="Start Your Project">
            <motion.button
              className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold rounded-full shadow-lg hover:shadow-2xl transform transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-400"
              whileHover={{
                scale: 1.05,
